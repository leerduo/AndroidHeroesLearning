...
/**
 * Created by chenfuduo on 2016/3/13.
 */
public class AMAdapter extends BaseAdapter {

    private List<AMInfo> mListData = null;
    private LayoutInflater mInfater;

    public AMAdapter(Context context, List<AMInfo> listData) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ViewHolder holder;
        if (convertView == null) {
            convertView = mInfater.inflate(R.layout.am_item, null);
        ...
        AMInfo processInfo = (AMInfo) getItem(position);
